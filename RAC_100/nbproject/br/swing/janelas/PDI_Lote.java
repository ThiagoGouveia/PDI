...
public class PDI_Lote extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Equalização_BPDHE = new javax.swing.JCheckBox();
        ...
        Equalização_BPDHE.setText("Equalização IPLSD");
        Equalização_BPDHE.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Equalização_BPDHEActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(Equalização_BPDHE)))
    ...
    private void Equalização_BPDHEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Equalização_BPDHEActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Equalização_BPDHEActionPerformed
    ...
    private void ProcessarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProcessarActionPerformed
        ...
        try {
            ...
            if (!CaminhoImagemOriginal.getText().isEmpty() && !CaminhoSaidaImagem.getText().isEmpty()) {
                ...
                if (Equalização_BPDHE.isSelected()) {
                    String k = JOptionPane.showInputDialog(null, "Entre com um valor para C (do tipo C>1): ");
                    ...
                    for (File pathtecnica01 : pathsOriginal) {
                        ...
                        String aSaida = pastaSalvar + imagevariavelK + Nome + "_" + k +".png";
    ...
    private javax.swing.JCheckBox Equalização_BPDHE;
